      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="http://www.atguigu.com/" title="在线教育" target="_blank">在线教育</a>
            </li>
          </ul>
          <div class="clear"/>
        </div>
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>服务热线：010-XXX(北京) 0755-XXX(深圳)</span>
                <span>Email：info@xxx.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2020课程版权均归在线教育学院所有 京ICP备XXX号</span>
              </section>
            </section>
          </section>
